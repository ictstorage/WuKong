...
import XiaoHe.{HasNutCoreParameter, MMUIO}
import chisel3._
...
import XiaoHe.SSDbackend.fu.SSDHasCSRConst
import utils._
import top.Settings
...
abstract class TlbModule(implicit tlbConfig: TLBConfig) extends NutCoreModule with HasNutCoreParameter with HasTlbConst with Sv39Const with SSDHasCSRConst
