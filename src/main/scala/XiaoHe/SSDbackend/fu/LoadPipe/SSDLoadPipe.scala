package XiaoHe.SSDbackend.fu.LoadPipe

import _root_.XiaoHe.SSDbackend.fu.{
    HasStoreBufferConst,
    LSUOpType,
    LoadPipe,
    StoreBufferEntry,
...
import _root_.XiaoHe.SSDbackend.fu.StoreBuffer

class loadPipeEntry extends NutCoreBundle {
...
class SSDLoadPipeIO extends NutCoreBundle with HasStoreBufferConst {
